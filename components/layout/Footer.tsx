...
export default function Footer() {
  ...
  return (
    <footer className="relative border-t border-[--border] bg-[--bg-card] overflow-hidden pb-28 md:pb-6">
      ...
      <div className="relative z-10 mx-auto grid max-w-[70rem] gap-6 sm:gap-8 px-6 py-12 sm:grid-cols-2 md:grid-cols-[2fr_1fr] lg:px-8">
        <div>
          <Link
            href="#hero"
          ...
          <div className="mt-4 grid gap-2.5">
            {socialLinks.map((link) => (
              <a
                ...
                className="group inline-flex items-center gap-1.5 text-sm font-medium text-[--text-secondary] transition-all duration-300 hover:text-[--text-primary] hover:translate-x-1"
              >
                {link.label}
      ...
      <div className="relative z-10 border-t border-[--border] bg-[--bg-base]/50 px-4 py-6">
        <p className="mx-auto flex max-w-[70rem] items-center justify-center gap-1.5 text-center text-xs md:text-sm font-medium text-[--text-muted]">
