      ...
      <div className="mx-auto max-w-4xl text-center">
        <div className={`fade-up ${visible ? "visible" : ""}`}>
          ...
          <p className="mx-auto max-w-2xl text-sm sm:text-lg md:text-xl text-[--text-secondary] font-light leading-relaxed mb-8 md:mb-12">
            I&rsquo;m currently open to new opportunities. Whether you have a question, a project offer,
            or just want to say hi, I&rsquo;ll try my best to get back to you as soon as possible.
          </p>

          <a
            href={socialMedia.email}
            className="group relative inline-flex h-14 md:h-16 lg:h-20 items-center justify-center gap-3 md:gap-4 overflow-hidden rounded-full bg-[--accent] px-8 md:px-10 lg:px-14 text-sm md:text-base lg:text-lg font-bold text-[#0A1428] transition-all duration-500 hover:scale-105 hover:shadow-[0_0_40px_var(--accent-glow)]"
          >
            Say Hello
        ...
        <div className={`mt-10 md:mt-12 flex items-center justify-center gap-6 md:gap-12 fade-up delay-2 ${visible ? "visible" : ""}`}>
          ...
          >
            <div className="flex h-14 w-14 md:h-16 md:w-16 items-center justify-center rounded-full border border-[--border] glass-panel bg-[--bg-card] shadow-lg transition-all duration-500 group-hover:scale-110 group-hover:border-[--border-accent] group-hover:shadow-[0_0_30px_var(--accent-glow)]">
              <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 md:h-7 md:w-7 fill-[--text-secondary] transition-colors group-hover:fill-[--text-primary]">
            ...
            <span className="text-xs md:text-sm font-semibold tracking-wider flex items-center gap-1 uppercase">
              GitHub <ArrowUpRight className="h-3.5 w-3.5 opacity-0 transition-opacity duration-300 group-hover:opacity-100 text-[--accent]" />
            </span>
          </a>
          ...
          >
            ...
            <span className="text-xs md:text-sm font-semibold tracking-wider flex items-center gap-1 uppercase">
              LinkedIn <ArrowUpRight className="h-3.5 w-3.5 opacity-0 transition-opacity duration-300 group-hover:opacity-100 text-[--accent]" />
            </span>
          </a>
        </div>
      </div>
