...
export default function AboutSection({
  ...
  return (
    <section id={id} ref={ref} className={cn("section-container", className)}>
      ...
      >
        <SectionLabel number={4} label="About" />
        <h2
      ...
      <div className="max-w-5xl mx-auto px-4 md:px-0">
        <SpotlightCard>
          <div
            className={`rounded-[1.5rem] md:rounded-[2rem] border border-[--border-accent] glass-panel p-6 md:p-10 lg:p-14 relative overflow-hidden group hover:border-[--accent] transition-colors duration-300 animated-border scale-in ${visible ? "visible" : ""}`}
          >
            <div className="absolute top-0 right-0 p-8 opacity-5 group-hover:opacity-10 transition-opacity duration-300 pointer-events-none">
              <Code2 className="w-20 md:w-32 lg:w-48 h-20 md:h-32 lg:h-48 text-[--accent]" />
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12 relative z-10">
              <div className="lg:col-span-4 flex flex-col justify-start">
                ...
                <div className="h-1 w-12 bg-gradient-to-r from-[--accent] to-[--magenta] rounded-full hidden lg:block mt-1" />
              </div>
              ...
              <div className="lg:col-span-8">
                <p className="text-base md:text-lg leading-relaxed text-[--text-secondary] opacity-90 font-light">
                  ...
                  , ensuring that every solution not only looks premium but also
                  runs with maximum performance.
                </p>
              </div>
            </div>
          </div>
